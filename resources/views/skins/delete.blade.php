...
<div class="py-6"></div>
    <h1 class="text-3xl font-bold mb-4 ml-8">Delete Skin</h1>
    <p class="ml-8">Do you want to delete the Skin "<?= htmlspecialchars($skin->name) ?>"?</p>
    <form action="/skindestroy" method="POST" class="mt-4">
